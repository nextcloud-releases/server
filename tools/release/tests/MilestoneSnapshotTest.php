...
final class MilestoneSnapshotTest extends TestCase
{
    ...
    public function testPatchRelease(): void
    {
        ...
        $this->assertMatchesSnapshot('milestones/patch-release', $this->snapshot($api));
    }
    ...
    public function testFirstStable(): void
    {
        ...
        $this->assertMatchesSnapshot('milestones/first-stable', $this->snapshot($api));
    }
    ...
    public function testFirstBeta(): void
    {
        ...
        $this->assertMatchesSnapshot('milestones/first-beta', $this->snapshot($api));
    }
    ...
    public function testMissingNext(): void
    {
        ...
        $api->seedIssue(self::SERVER, 100, 10);
        (new MilestoneUpdater($api))->run(Version::fromTag('v33.0.4'), [self::SERVER]);
        $this->assertMatchesSnapshot('milestones/missing-next', $this->snapshot($api));
    }
    ...
    public function testDueDates(): void
    {
        ...
        $this->assertMatchesSnapshot('milestones/due-dates', $this->snapshot($api));
    }
    ...
    public function testMultiRepo(): void
    {
        ...
        $this->assertMatchesSnapshot('milestones/multi-repo', $this->snapshot($api));
    }
    ...
    public function testPrereleaseNoop(): void
    {
        ...
        $this->assertMatchesSnapshot('milestones/prerelease-noop', $this->snapshot($api));
    }
}
