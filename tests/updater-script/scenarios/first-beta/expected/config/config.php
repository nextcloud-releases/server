	...
	'stable' => [
		'33' => [
			'100' => [
				...
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-33.0.5.zip',
				'downloads' => [
					'bz2' => [
						'0' => 'https://github.com/nextcloud-releases/server/releases/download/v33.0.5/nextcloud-33.0.5.tar.bz2',
						'1' => 'https://download.nextcloud.com/server/releases/nextcloud-33.0.5.tar.bz2',
					],
					'zip' => [
						'0' => 'https://github.com/nextcloud-releases/server/releases/download/v33.0.5/nextcloud-33.0.5.zip',
						'1' => 'https://download.nextcloud.com/server/releases/nextcloud-33.0.5.zip',
					],
				],
				'web' => 'https://docs.nextcloud.com/server/33/admin_manual/maintenance/upgrade.html',
				'eol' => '2027-02-18',
				'minPHPVersion' => '8.2',
				'signature' => 'srq41voRX6MJhV4uKhKD63uZMYQ0OVrTfdC2aKEY6st/dVJtEa9Us5Gs8HCS0sJ0
...
Q36WWyhFw7is33ZSGoRW8w==',
				'signatures' => [
					'bz2' => '',
					'zip' => '
...
Q36WWyhFw7is33ZSGoRW8w==',
		...
		'32' => [
			'100' => [
				...
				'downloadUrl' => 'https://download.nextcloud.com/server/releases/nextcloud-32.0.11.zip',
				'downloads' => [
					'bz2' => [
...
yvE6RPkGve7ePndOyln6mw==',
				'signatures' => [
					'bz2' => '',
					'zip' => '',
	...
	'beta' => [
		'35' => [
			'100' => [
				'latest' => '35.0.0 beta 1',
				'internalVersion' => '35.0.0.1',
				'downloadUrl' => 'https://download.nextcloud.com/server/prereleases/nextcloud-35.0.0beta1.zip',
				'downloads' => [
					'bz2' => [
						'0' => 'https://github.com/nextcloud-releases/server/releases/download/v35.0.0beta1/nextcloud-35.0.0beta1.tar.bz2',
						'1' => 'https://download.nextcloud.com/server/prereleases/nextcloud-35.0.0beta1.tar.bz2',
					],
					'zip' => [
						'0' => 'https://github.com/nextcloud-releases/server/releases/download/v35.0.0beta1/nextcloud-35.0.0beta1.zip',
						'1' => 'https://download.nextcloud.com/server/prereleases/nextcloud-35.0.0beta1.zip',
					],
				],
				'web' => 'https://docs.nextcloud.com/server/35/admin_manual/maintenance/upgrade.html',
				'eol' => '',
				'minPHPVersion' => '8.2',
				'signature' => 'TestZIPSig000000000000000000000000000000000000000000000000000000
...
TestZIPSig000000000000==',
				'signatures' => [
					'bz2' => '',
...
ILUlWHKNuhVMDCWn0BkbFw==',
	...
	'daily' => [
		...
		'34' => [
			'downloadUrl' => 'https://download.nextcloud.com/server/daily/latest-stable34.zip',
			'web' => 'https://docs.nextcloud.com/server/34/admin_manual/maintenance/upgrade.html',
			'eol' => '',
			'minPHPVersion' => '8.2',
		],
		'33' => [
			'downloadUrl' => 'https://download.nextcloud.com/server/daily/latest-stable33.zip',
			'web' => 'https://docs.nextcloud.com/server/33/admin_manual/maintenance/upgrade.html',
			'eol' => '2027-02-18',
			'minPHPVersion' => '8.2',
		],
